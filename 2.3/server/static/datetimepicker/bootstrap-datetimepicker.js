...
(function(factory){
  ...
  let Datetimepicker = function (element, options) {
    ...
    if (this.isRTL) {
      ...
      let selector = this.bootcssVer === 3 ? '.prev span, .next span' : '.prev i, .next i';
    ...
    this.onRenderDay = function (date) {
      let render = (options.onRenderDay || function () { return []; })(date);
    ...
    this.onRenderHour = function (date) {
      let render = (options.onRenderHour || function () { return []; })(date);
      let res = ['hour'];
      if (typeof render === 'string') {
        render = [render];
      }
    ...
    this.onRenderMinute = function (date) {
      let render = (options.onRenderMinute || function () { return []; })(date);
      let res = ['minute'];
      if (typeof render === 'string') {
        render = [render];
      }
    ...
    this.onRenderYear = function (date) {
      let render = (options.onRenderYear || function () { return []; })(date);
      let res = ['year'];
      if (typeof render === 'string') {
        render = [render];
      }
    ...
    this.onRenderMonth = function (date) {
      let render = (options.onRenderMonth || function () { return []; })(date);
      let res = ['month'];
      if (typeof render === 'string') {
        render = [render];
      }
  ...
  Datetimepicker.prototype = {
    ...
    place: function () {
      ...
      let bodyWidth = document.body.clientWidth || window.innerWidth;
    ...
    fillMonths: function () {
      ...
      for (let i = 0; i < 12; i++) {
        d.setUTCMonth(i);
        let classes = this.onRenderMonth(d);
    ...
    fill: function () {
      ...
      let hoursDisabled = this.hoursDisabled || [];
      ...
      meridian = '';
      meridianOld = '';
      let minutesDisabled = this.minutesDisabled || [];
      d = new Date(this.viewDate);
      ...
      let currentYear = this.date.getUTCFullYear();
      let months = this.setTitle('.datetimepicker-months', year)
        .end()
      ...
      let yearCont = this.setTitle('.datetimepicker-years', year + '-' + (year + 9))
        .end()
        .find('td');
      year -= 1;
      d = new Date(this.viewDate);
    ...
    mousewheel: function (e) {
      ...
      let delta = originalEvent.wheelDelta;
  ...
  let dates = $.fn.datetimepicker.dates = {
    en: {
  ...
  let DPGlobal = {
    ...
    parseFormat: function (format, type) {
      ...
      let separators = format.replace(this.validParts(type), '\0').split('\0'),
    ...
    parseDate: function (date, format, language, type, timezone) {
      if (date instanceof Date) {
        let dateUTC = new Date(date.valueOf() - date.getTimezoneOffset() * 60000);
      ...
      let parts = date && date.toString().match(this.nonpunctuation) || [],
