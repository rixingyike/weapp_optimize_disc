...
// 从微信服务器拉取小程序的性能信息
// GET：api/home/performance/10022
func (c *HomeController) GetPerformanceBy(module string) models.Result {
	var accessToken = getAccessToken()
	var url = fmt.Sprintf("https://api.weixin.qq.com/wxa/business/performance/boot?access_token=%s", accessToken)
	println(url)
	var strData = `{
	"time": {
	"end_timestamp": 1649849056,
	"begin_timestamp": 1649676289
	},
	"module": "%s",
	"params": [{
	"field": "networktype",
	...
	strData = fmt.Sprintf(strData, module)
	println(strData)
	...
	return models.Result{Data: result, ErrMsg: "ok"}
}